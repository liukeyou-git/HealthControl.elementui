            ...
            <div class="margin-top-sm">
                <el-form :inline="true" :model="searchForm" size="default">
                    ...
                    <el-form-item label="分类">
                        <SigleSelect url="/HealthArticleType/List" class="search-input" columnName="Name" :clearable="true" columnValue="Id"
                            v-model="searchForm.HealthArticleTypeId">
                        </SigleSelect>
                    </el-form-item>                
...
<!-- 编辑对话框 -->
              ...
              <el-row :gutter="10" class="edit-from-body">
                    ...
                    <el-col :span="24">
                        <el-form-item label="分类" prop="HealthArticleTypeId">
                          <SigleSelect url="/HealthArticleType/List" columnName="Name" columnValue="Id"  v-model="formData.HealthArticleTypeId" >
                          </SigleSelect>
                        </el-form-item>
                    </el-col>
        ...
        <!-- 数据表格 -->
        <PaginationTable ref="PaginationTableId" url="/HealthArticle/List" :column="columnList" :where="where">
